...
The retained [corpus-v2 evidence](../../docs/evidence/VISUAL-SLM/corpus-v2/summary.md) records 179 admitted cases (one honest skip), an untouched koel holdout scoring 20/20 recall with 0 false positives after the threshold-policy tightening — while the spec's uncertainty and incremental-value gates keep promotion blocked.
