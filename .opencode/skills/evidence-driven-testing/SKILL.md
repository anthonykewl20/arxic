...
---
*Source: [michaelshimeles/skills · evidence-driven-testing](https://github.com/michaelshimeles/skills/tree/main/evidence-driven-testing). Installed verbatim with attribution; see `.opencode/skills/README.md`. Upstream license: see source repo.*
