...
[Readability evidence](../../docs/evidence/WEB-445-READABILITY/summary.md) retains the three-engine source results, measured defects, corrected screenshots and explicit limits. PR #446 tracks installed CI, including the explicit 1/65536 CSS pixel measurement resolution and the unresolved WebKit baseline-history error. Release acceptance remains pending.
