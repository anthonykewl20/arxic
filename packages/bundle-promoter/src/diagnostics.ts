...
export const ARXIC_PROMOTION_PLAN_BINDING_FAILED = 'ARXIC-PROMOTION-PLAN-BINDING-FAILED' as const;
...
export const ARXIC_PROMOTION_SCREENSHOT_PRIVACY_FAILED =
  'ARXIC-PROMOTION-SCREENSHOT-PRIVACY-FAILED' as const;
