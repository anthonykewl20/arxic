...
export const ARXIC_COMPILE_OBSERVATION_STEP_FAILED =
  'ARXIC-COMPILE-OBSERVATION-STEP-FAILED' as const;
export const ARXIC_COMPILE_OBSERVATION_DRIFT = 'ARXIC-COMPILE-OBSERVATION-DRIFT' as const;
export const ARXIC_COMPILE_OBSERVATION_UNSTABLE = 'ARXIC-COMPILE-OBSERVATION-UNSTABLE' as const;
export const ARXIC_COMPILE_DERIVATION_EMPTY = 'ARXIC-COMPILE-DERIVATION-EMPTY' as const;
