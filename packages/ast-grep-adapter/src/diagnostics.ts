...
export const ARXIC_RULES_FRAMEWORK_ACCEPTED = 'ARXIC-RULES-FRAMEWORK-ACCEPTED' as const;
export const ARXIC_RULES_FRAMEWORK_REJECTED = 'ARXIC-RULES-FRAMEWORK-REJECTED' as const;
export const ARXIC_RULES_FRAMEWORK_UNKNOWN = 'ARXIC-RULES-FRAMEWORK-UNKNOWN' as const;
export const ARXIC_RULES_FRAMEWORK_UNDETECTED = 'ARXIC-RULES-FRAMEWORK-UNDETECTED' as const;
export const ARXIC_RULES_FRAMEWORK_WAIVED = 'ARXIC-RULES-FRAMEWORK-WAIVED' as const;
export const ARXIC_RULES_WAIVER_INVALID = 'ARXIC-RULES-WAIVER-INVALID' as const;
