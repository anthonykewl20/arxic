...
export const ARXIC_ORCH_WORKFLOW_SCOPE = 'ARXIC-ORCH-WORKFLOW-SCOPE' as const;
...
export const ARXIC_ORCH_HEALING_DEFERRED = 'ARXIC-ORCH-HEALING-DEFERRED' as const;
...
export const ARXIC_ORCH_MODEL_BUDGET_EXCEEDED = 'ARXIC-ORCH-MODEL-BUDGET-EXCEEDED' as const;
export const ARXIC_ORCH_PROPOSAL_INVENTORY_REF_DANGLING =
  'ARXIC-ORCH-PROPOSAL-INVENTORY-REF-DANGLING' as const;
export const ARXIC_ORCH_PROPOSAL_EVIDENCE_REF_DANGLING =
  'ARXIC-ORCH-PROPOSAL-EVIDENCE-REF-DANGLING' as const;
export const ARXIC_ORCH_PROPOSAL_SURFACE_MISSING = 'ARXIC-ORCH-PROPOSAL-SURFACE-MISSING' as const;

/** #324 (F-E14): honest non-coverage record — a row the model never proposed. */
export const ARXIC_ORCH_PROPOSAL_ROW_UNPROPOSED = 'ARXIC-ORCH-PROPOSAL-ROW-UNPROPOSED' as const;
