...
export const ARXIC_MANIFEST_INVALID = 'ARXIC-MANIFEST-INVALID' as const;
export const ARXIC_MANIFEST_GATE_MISSING = 'ARXIC-MANIFEST-GATE-MISSING' as const;
export const ARXIC_MANIFEST_DENOMINATOR_INVALID = 'ARXIC-MANIFEST-DENOMINATOR-INVALID' as const;
