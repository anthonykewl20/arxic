...
| Visual regression          | Stable anonymous/redirect-authenticated viewport captures, explicit baseline approval, real pixel differences and scoped numeric text contrast                    | Authenticated workflow checkpoints, responsive/state coverage, reviewed baseline lifecycle             |
