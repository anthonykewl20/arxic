...
| AI-assisted E2E            | Existing pipeline from the dashboard; optional file-based source-row scope; one candidate's ledger and verifier outcome                                        | Comprehensive scoped multi-workflow campaigns and independent business acceptance criteria |
