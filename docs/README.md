...
This is the current user-documentation snapshot for Arxic 0.1.1. The current
...
| -------------------------------------------------- | ------- | ----------------------------------------------------------------------------------------- |
| [Quickstart](./quickstart.md)                      | 0.1.1   | Install the CLI, prepare an attested local target, make a configuration file, and run it. |
| [CLI reference](./cli-reference.md)                | 0.1.1   | Commands, flags, environment variables, exits, and run records.                           |
| [Configuration reference](./configuration.md)      | 0.1.1   | Every accepted `arxic.yaml` field, its validation rules, and a complete example.          |
| [Attestation guide](./attestation-for-your-app.md) | 0.1.1   | Add the required target attestation endpoint to an application you may test.              |
| [Worker deployment](./operator/worker-deploy.md)   | 0.1.1   | Build and deploy the worker image in lockstep with the CLI.                               |
