# Streamline admin panel access

Workflow: `prop:766ef534236e8526`
...
| --- | --- | --- | --- |
| admin-page → admin-login-page | Submit streamline admin panel access form via "Sign In" | url:/admin/login | required |
