...
- Probe defects found and fixed en route: a 64 KiB spawnSync maxBuffer overflow killed 128-region children masquerading as timeouts (fixed to 4 MiB); the hard-failure assertion was clip-case-specific (scoped to clip cases).
