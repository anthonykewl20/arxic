...
- Gates: typecheck ☑ · lint ☑ · format ☑ · test (recurrence 3/3 ×2, campaigns+workspace 5/5, campaigns/campaign-ui/workflow-captures 10/10) ☑ · license gate → CI (blocked by the 403 push refusal).

## 5. Sad paths proved (each mapped to a truth state, charter §4)
