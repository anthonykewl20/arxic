...
- Gates: typecheck ☑ · lint ☑ · typecheck:packages ☑ · format:check ☑ · test (55 new, suite green) ☑ · license gate ☑ (no new external deps)
...
| Off-origin observation step URL (absolute-URL escape)             | blocked PRE-FLIGHT, zero navigations (review P2 remediation; `ARXIC-DG03-OBSERVATION-DRIFTED`) | `observation.test.ts`                                           |
| Unparseable observation step URL                                  | blocked pre-flight, zero navigations                                                           | `observation.test.ts`                                           |
